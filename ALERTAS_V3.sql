...
SELECT 
	...
	CONVERT(SMALLINT, SUBSTRING(ALERTA, PATINDEX('%IDEMPRESA=%',ALERTA)+10,
			  CHARINDEX('/',ALERTA,PATINDEX('%IDEMPRESA=%',ALERTA)+10)-PATINDEX('%IDEMPRESA=%',ALERTA)-10)) AS ID_EMPRESA,
